...
class QwenClient:
    ...
    def __init__(self, api_url: str = "http://127.0.0.1:1234"):
        ...
        self.system_prompt = """You are a computer vision system specialized in identifying UI elements in app screenshots with extreme precision.
...
Respond ONLY with JSON and nothing else."""
    ...
    def detect_ui_elements(self, image_path: str) -> List[BoundingBox]:
        ...
        try:
            ...
            prompt = f"Analyze this app screenshot and identify all UI elements with exact coordinates."
