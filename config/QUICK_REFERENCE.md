...
- **Your configs:** `config/apps/yourconfig.yaml`
- **Screenshots:** `Automation Logs/[App Name]/screenshots/`
- **Annotations:** `Automation Logs/[App Name]/annotated/`
- **Logs:** `Automation Logs/[App Name]/automation.log`
...
9. **Be patient** - Apps can be slow to respond
...
- **Existing configs:** `config/apps/*.yaml`
