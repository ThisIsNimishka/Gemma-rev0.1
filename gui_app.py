...
class AutomationGUI:
    def __init__(self, root):
        ...
        self.omniparser_url = tk.StringVar(value="http://localhost:9000")  # Default Omniparser Queue Manager URL
        self.running = False
    ...
    def create_widgets(self):
        ...
        ttk.Label(omniparser_url_row, text="Omniparser Queue Manager URL:").pack(side=tk.LEFT, padx=(0, 5))
